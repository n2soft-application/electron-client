...
//     <div>
//       <p className="font-semibold text-center">Basic Badges</p>
...
//     </div>
//     <div>
//       <p className="font-semibold text-center">Pill Badges</p>
//       <div className="flex gap-2 mt-2">
...
//     </div>
//     <div>
//       <p className="font-semibold text-center">Soft Badges</p>
//       <div className="flex gap-2 mt-2">
//         <Badge
//           label="primary"
...
//     </div>
//     <div>
//       <p className="font-semibold text-center">Soft Pill Badges</p>
//       <div className="flex gap-2 mt-2">
//         <Badge
//           label="primary"
...
//     </div>
//     <div>
//       <p className="font-semibold text-center">Badges With Icon</p>
//       <div className="flex gap-2 mt-2">
//         <Badge
//           label="primary"
//           className="text-white bg-primary-500 "
...
export const BasicBadges: Story = () => (
  <div className="flex gap-2">
    ...
    <Badge label="info" className="text-white bg-info-500" />
    <Badge label="warning" className="text-white bg-warning-500" />
    <Badge label="Dark" className="text-white bg-slate-800 dark:bg-slate-900" />
  </div>
);
BasicBadges.args = {
  ...BasicBadges.args,
