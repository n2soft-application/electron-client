...
const Profile = () => {
  return (
    <div className="px-8 py-10 rounded-lg bg-white dark:bg-slate-800 justify-between flex flex-col text-center items-center relative z-[1]">
      ...
      <div className="">
        ...
        <div className="flex-1 mb-6">
          <div className="mb-1 text-2xl font-semibold text-slate-900 dark:text-slate-200">
            홍길동
          </div>
          <div className="mb-2 text-sm font-semibold text-slate-900 dark:text-slate-200">
            리테일금융본부 / 본부장
          </div>
      ...
      <div className="text-base font-medium text-slate-900 dark:text-slate-300">
